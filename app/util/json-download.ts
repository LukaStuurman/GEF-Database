  ...
  const json: Record<string, unknown> = {
    ...
    metadata: {
      ...
      coordinates: processed.coordinateSystem
        ? {
            system: {
              name: processed.coordinateSystem.name ?? null,
              epsg: processed.coordinateSystem.epsg ?? null,
            },
      ...
      elevation: processed.heightSystem
        ? {
            ...
            system: {
              name: processed.heightSystem.name ?? null,
              epsg: processed.heightSystem.epsg ?? null,
            },
          }
        : null,
    },
